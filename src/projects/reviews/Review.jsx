    ...
    <div>
      ...
      <div>
        ...
        <table className="m-auto">
          <thead>
        <tr>
          <th className="border border-blue-200 bg-sky-800  px-10 py-2">Title</th>
          <th className="border border-blue-200 bg-sky-800  px-10 py-2">Name</th>
          <th className="border border-blue-200 bg-sky-800  px-10 py-2">Rating</th>
          <th className="border border-blue-200 bg-sky-800  px-10 py-2">Description</th>
        </tr>
        </thead>
        <tbody>
        {store.map((item) => (
